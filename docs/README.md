...
- `datasets/public_sleep`: Sleep-EDF and ISRUC loaders, canonical labels `W/N1/N2/N3/REM`, and public-data adapters.
...
- `brainstim_task`: Chinese prompts, countdown, LSL markers, and CSV logs for calibration.
